...
const itemsObj: Item[] = [
  ...
  },
  {
    ...
    description:
      "<p>100% Polyester</p> <p>Imported</p> <p>Zipper closure</p> <p>Hand Wash Only</p> <p>This is a beaded gown with sweetheart neckline and short flutter sleeves</p> <p>Patterned beaded mesh embellishment</p><p>Sweetheart neckline</p> <p>Short flutter sleeves</p> <p>Soft skirt silhouette</p>",
    category: "dresses",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>95% Polyester, 5% Spandex</p> <p>Pull On closure</p> <p>Machine Wash</p> <p>Stretch jersey</p> <p>3/4 length sleeves</p> <p>Off the shoulder</p><p>Fishtail hem</p> <p>Wrinkle free</p>",
    category: "dresses",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>67% Polyester, 27% Rayon, 6% Spandex</p> <p>Imported</p> <p>Zipper closure</p> <p>Dry Clean Only</p> <p>With Likely, you're most #Likelyto win best dressed, nail the group-shot, dance all night, and then do it all again next weekend. </p> <p>We're your partner-in-crime for any and every occasion.</p><p>From form-fitting and flowy dresses we've got you (and your wallet!) covered so you never have to worry about what you'll wear to your next RSVP.</p>",
    category: "dresses",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>80% Polyester, 20% Rayon</p> <p>Imported</p> <p>HAND WASH COLD SEPARATELY, DO NOT BLEACH, LAY FLAT TO DRY, LOW IRON IF NECESSARY, OR DRY CLEAN</p> <p>The Picnic Ready Dress is a textured gingham tiered mini</p> <p>It has puff sleeves and a subtle ruffle detail at the neckline</p> <pItem Package Weight: 0.3 kilograms></p>",
    category: "dresses",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>97% Polyester, 3% Spandex</p> <p>Imported</p> <p>Zipper closure</p> <p>Machine Wash</p> <p>Special Size Type: Standard</p> <p>Weave Type: Woven</p>",
    category: "dresses",
    attributes: [],
  },
  {
  ...
  },
  {
    ...
    description:
      "<p>Delicate Chiffon Fabric, Soft And Lightweight</p> <p>Classic Solid Color With beautiful details</p> <p>Relaxed Fit with A-Line Shape Fit For All The Body Shape</p> <p>Above Knee Length Visually Highlight Your Long Legs</p>",
    category: "dresses",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>95% Polyester, 5% Elastane</p> <p>Imported</p> <p>Machine Wash</p> <p>Staples by The Drop</p> <p>Model is 5'10`/178 cm and wearing a size S</p>",
    category: "dresses",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>95% Polyester,5% Spandex</p> <p>Zipper closure</p> <p>Hand Wash Only</p> <p>This cute swing midi dress features Sleeveless, Sweetheart neck, smocked top, A-line silhouette, Concealed zipper at side, Adjustable strap</p> <p>The elastic ribbing in the back and bust, giving so much extra stretch to fit most bust. </p> <p>The A-line shape design perfectly accentuates your waist to show off your curves</p> <p>Adjustable strap design could make you feel breathable and comfortable all day</p>",
    category: "dresses",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>100% Silk</p> <p>Made in the USA and imported</p> <p>Button closure</p> <p>Hand wash or dry clean</p> ",
    category: "blouses",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>51% Viscose, 49% Polyamide</p> <p>Imported</p><p>Pull On closure</p><p>Dry Clean Only</p><p>Semi-sheer floral lace.</p>",
    category: "blouses",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>100% Silk</p><p>Imported</p><p>Button closure</p><p>Dry Clean Only</p><p>Timeless and innovative</p> <p>The collection excudes discreet sexiness in the form of luxe fabrics and unexpected details found in modern silhouettes</p> ",
    category: "blouses",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>82% Rayon, 18% Silk</p> <p>Made in the USA and imported</p> <p>Button closure</p> <p>Dry clean only</p><p>Lined bodice</p>",
    category: "blouses",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>100% Silk</p> <p>Imported</p><p>Button closure</p><p>Dry clean only</p><p>Fits true to size</p><p>Timeless and innovative</p> <p>The collection excudes discreet sexiness in the form of luxe fabrics and unexpected details found in modern silhouettes</p>",
    category: "blouses",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>100% Cotton</p> <p>Imported</p> <p>Pull On closure</p> <p>Machine Wash</p> <p>The elastic around the top has ruffle detailing to add extra to the dress</p> <p>Easy top for warmer weather and pairs great with denim</p> ",
    category: "blouses",
    attributes: [
      {
        id: "Color",
  ...
  },
  {
    ...
    description:
      "<p>100% Polyester</p> <p>Imported</p> <p>front closure</p> <p>Dry Clean Only</p> <p>Designed to fit and flatter 5'4` and under frame</p>  <p>Mock-neck, back keyhole and button closure</p> <p>Ruffle at neckline and center front</p>",
    category: "blouses",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>100% Silk</p> <p>Imported</p> <p>Pull On closure    </p> <p>Dry Clean Only    </p> <p>A cascading placket from the collar band accentuate the easy drape of our satin crepe long sleeve blouse.    </p> <p>Front tie closure.      </p> <p>Agoya button cuffs.      </p> <p>Fits true to size      </p>",
    category: "blouses",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>100% Silk</p> <p>Imported</p> <p>Pull On closure</p> <p>Hand wash cold. Line dry. Or dry clean.</p> <p>Slips on. Agoya button cuff. Back yoke.</p>",
    category: "blouses",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>82% Rayon, 18% Silk</p> <p>Made in the USA and imported</p> <p>Button closure</p> <p>Dry clean only</p> <p>Devore velvet</p> <p>Lined bodice</p>",
    category: "blouses",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>99% cotton, 1% spandex</p> <p>Imported</p> <p>Dry Clean Only</p><p>Mid-weight stretch denim</p><p>Raw cuffs</p><p>Rise: 11in / 28cm</p><p>Inseam: 26.5in / 67cm</p><p>Leg opening: 15.75in / 40cm</p>",
    category: "jeans",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>70% Cotton, 28% Polyester, 2% Elastane</p> <p>Imported</p> <p>Zipper closure</p><p>Machine Wash</p><p>Mid rise, slim through hip and thigh with a super skinny leg</p><p>Zip fly and button closure, 5-pockets + belt loops</p><p>Updated j-stitch constructio</p>",
    category: "jeans",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>58% Cotton, 20.2% Rayon, 13.4% Modal, 6% T400, 2.4% Lycra</p> <p>Imported</p> <p>Snap closure</p><p>28` Inseam, Mid-rise</p>9-1/2` Front rise, 9-3/4` Leg opening for size <p></p><p>UV Protection</p><p>Set-in waistband with loops</p><p>Faux zipper with working button</p>",
    category: "jeans",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>93% COTTON , 5% POLYESTER , 2% SPANDEX</p> <p>Imported</p> <p>Zipper closure</p><p>Machine Wash</p><p>paige vintage</p><p>high rise</p><p>wide leg</p>",
    category: "jeans",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>100% Cotton</p> <p>Made in the USA and imported</p> <p>Button closure</p> <p>Machine Wash</p>   <p>Slim through hip and thigh</p> <p>Perfect rise</p> <p>Boot cut</p>",
    category: "jeans",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>Button closure</p> <p>68% Cotton/23% Polyester/8% Viscose/1% Elastane</p> <p>Imported</p> <p>Wash And Dry Inside Out With Like Colors, Liquid Detergent Is Recommended</p>   <p>Midrise skinny jean with five-pocket styling and button closure</p> <p>Slim through hip and thigh</p>",
    category: "jeans",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>Drawstring closure</p> <p>Machine Wash</p> <p>CLOSURE TYPE: Elastic, Drawstring</p> <p>FIT: Athletic, RISE: Low Rise, INSEAM: 27` Inches</p>   <p>2 Front Slip Pockets, 2 Back Slip Pockets</p> <p>75% Cotton, 22% Polyester, 3% Rayon</p> <p>Machine Wash, Tumble Dry</p>",
    category: "jeans",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>100% Cotton</p> <p>Imported</p> <p>Snap closure</p><p>28` Inseam, Mid-rise</p>9-1/2` Front rise, 9-3/4` Leg opening for size <p></p><p>UV Protection</p><p>Set-in waistband with loops</p><p>Faux zipper with working button</p>",
    category: "jeans",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>100% Synthetic</p> <p>Imported</p>  <p>Leather sole</p>  <p>Heeled Sandal</p>  <p>Stilleto Heel</p>  <p>Square Toe</p>  <p>Thin Strappy Upper</p>",
    category: "shoes",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>Imported</p> <p>Synthetic sole</p>  <p>Heel measures approximately 3.9` inches</p>  <p>Synthetic Material</p>  <p>Pump - Evening</p>  <p>Buckle Closure</p> ",
    category: "shoes",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>100% Synthetic</p> <p>Imported</p>  <p>Man Made sole</p>  <p>Platform measures approximately 0.5 inches inches inches</p>  <p>Vegan</p>  <p>Canvas Sock Liner</p>",
    category: "shoes",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>100% Cotton</p> <p>Imported</p>  <p>Thermoplastic Rubber sole</p>  <p>Heel measures approximately 4.5`</p>  <p>Chunky braided straps</p>  <p>Embellished straps</p>  <p>Slip on Style</p>  <p>Square Open Toe</p>",
    category: "shoes",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>Faux Suede</p> <p>Imported</p>  <p>Suede sole</p>  <p>Heel measures approximately 3.91 inches</p>  <p>Faux Suede Material</p>  <p>Sandal - Heeled</p>  <p>Elastic Closure</p>",
    category: "shoes",
    attributes: [
      {
        id: "Size",
  ...
  },
  {
    ...
    description:
      "<p>Imported</p> <p>Thermoplastic Rubber sole</p>  <p>Heeled Slide Sandal</p>  <p>Thin Double Toe Straps</p>  <p>Square Open Toe</p>  <p>Angled Block Heel</p>",
    category: "shoes",
    attributes: [
      {
        id: "Size",
